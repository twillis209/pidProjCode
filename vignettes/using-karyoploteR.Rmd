...
emptyGRanges <- GenomicRanges(P = numeric())

multitrack_manhattan(list(emptyGRanges), axis_labels = list('-log10(p)'), main = 'The virtues of an empty GenomicRanges object', axis_label_margin = axis_label_margin)
```
