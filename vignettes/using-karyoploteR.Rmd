...
kp <- kpPlotGenes(kp, data = genes.data.merged, r0 = 0, r1 = 0.2, cex = 0.8, gene.name.position = 'left')
```
...
```{r wholeGenomeManhattan, fig.width = 9}
...
backToBackManhattan(pidGRanges, igadGRanges, topLabel='PID', bottomLabel='IgAD', main='PID and IgAD', axisLabelCex=1, axisLabelMargin=label.margin, mainTitleCex = cex.main, plotParams = pp, chromNamesCex = chrom.names.cex)
```

```{r singleChromosomeManhattan}
backToBackManhattan(pidGRanges, igadGRanges, topLabel='PID', bottomLabel='IgAD', main='Chromosome 6', chromosomes='chr6', tickDist=3e7, axisLabelCex=1, axisLabelMargin=label.margin, mainTitleCex = cex.main, plotParams = pp)
```

```{r singleChromosomeThreeTracksManhattan}
backToBackManhattan(pidGRanges, igadGRanges, topLabel='PID', bottomLabel='IgAD', thirdLabel = 'SLE', thirdGRanges = sleGRanges, main='Chromosome 6', chromosomes='chr6', tickDist=3e7, axisLabelCex=1, axisLabelMargin=label.margin, mainTitleCex = cex.main, plotParams = pp)
```

```{r zoomedManhattanBackToBack}
backToBackManhattan(pidGRanges, igadGRanges, topLabel='PID', bottomLabel='IgAD', main='Chromosome 6, 25M-26M', zoom='chr6:25e6-36e6', tickDist=1e6, axisLabelCex=1, axisLabelMargin=label.margin, mainTitleCex = cex.main, plotParams = pp)
```

```{r zoomedManhattanWithGenes}
backToBackManhattan(pidGRanges, igadGRanges, topLabel='PID', bottomLabel='IgAD', main='Chromosome 6, 25M-26M', zoom='chr6:25e6-26e6', tickDist=1e5, plotGenes=T, axisLabelCex=1, axisLabelMargin=label.margin, mainTitleCex = cex.main, plotParams = pp, geneNamesCex = 0.7)
```

```{r zoomedManhattanWithThreeTracksAndGenes}
backToBackManhattan(pidGRanges, igadGRanges, topLabel='PID', bottomLabel='IgAD', thirdGRanges=sleGRanges, thirdLabel='SLE', main='Chromosome 6, 25M-26M', zoom='chr6:25e6-26e6', tickDist=1e5, plotGenes=T, axisLabelCex=1, axisLabelMargin=label.margin, mainTitleCex = cex.main, plotParams = pp, geneNamesCex = 0.7)
```